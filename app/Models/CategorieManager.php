...
class CategorieManager extends Manager{
    ...
    public function getCategories(){
        $bdd = $this->bdConnect();
        $req = $bdd->query('SELECT `id`, `title`, `content` FROM categories');
    ...
    public function getCategorie($id){
        $bdd = $this->bdConnect();
        $req = $bdd->prepare('SELECT `id`, `title`, `content` FROM categories  WHERE id=?');
    ...
    public function getJeuCategorie($id){
        $bdd = $this->bdConnect();
        $req = $bdd->prepare('SELECT `id`, `title`, `content` FROM categories  WHERE id=(SELECT categorie FROM jeux where id=?)');
        $req->execute(array($id));
        return $req;
    }
